...
var ProviderClass = (function () {
    function ProviderClass(provider, onInitCallback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isConnected) {
                            return [2, this._onReq.apply(this, __spreadArrays(['request', methods], args))];
                        }
    ...
    ProviderClass.prototype.sendNotification = function (methods) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.isConnected) {
                    return [2, this._onReq.apply(this, __spreadArrays(['sendNotification', methods], args))];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        params = this._provider.subscribe ? __spreadArrays([methodName], args) : args;
                    ...
                    case 1:
                        ...
                        rep = rep.result;
                        return [3, 4];
                    case 2: return [4, this._onReq.apply(this, __spreadArrays(['request', subMethodName], params))];
                    case 3:
                        rep = _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    ProviderClass.prototype._onReq = function (type, methods) {
        ...
        return new Promise(function (res, rej) {
            var _q = function () {
                _this[type].apply(_this, __spreadArrays([methods], args)).then(function (data) {
    ...
    ProviderClass.prototype.connectedOnce = function (cb) {
        var _this = this;
        var connectedCB = function () {
            _this.isConnected = true;
            _this.requestList && Object.values(_this.requestList).forEach(function (_q) {
                _q && _q();
            });
            cb && cb(_this);
        };

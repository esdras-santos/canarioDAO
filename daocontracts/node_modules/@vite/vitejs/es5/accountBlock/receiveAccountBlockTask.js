...
var ReceiveAccountBlockTask = (function () {
    function ReceiveAccountBlockTask(_a) {
        ...
        this._account = new account_1.default(address);
    ...
    ReceiveAccountBlockTask.prototype.reveive = function (pageSize) {
        return __awaiter(this, void 0, void 0, function () {
            var unreceivedBlocks, error_1, accountBlockList, _i, unreceivedBlocks_1, unreceivedBlock, previousAccountBlock, sendBlockHash, accountBlock, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        accountBlockList = [];
                        _i = 0, unreceivedBlocks_1 = unreceivedBlocks;
                        _a.label = 5;
                    case 5:
                        if (!(_i < unreceivedBlocks_1.length)) return [3, 10];
                        unreceivedBlock = unreceivedBlocks_1[_i];
    ...
    ReceiveAccountBlockTask.prototype.receiveAccountBlockByPrevious = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        accountBlock = this._account.receive({ sendBlockHash: sendBlockHash });

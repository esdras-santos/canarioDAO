...
var AccountClass = (function () {
    ...
    AccountClass.prototype.setProvider = function (provider) {
    ...
    AccountClass.prototype.receive = function (_b) {
    ...
    AccountClass.prototype.send = function (_b) {
    ...
    AccountClass.prototype.createContract = function (_b) {
    ...
    AccountClass.prototype.callContract = function (_b) {
    ...
    AccountClass.prototype.registerSBP = function (_b) {
    ...
    AccountClass.prototype.updateSBPBlockProducingAddress = function (_b) {
    ...
    AccountClass.prototype.updateSBPRewardWithdrawAddress = function (_b) {
    ...
    AccountClass.prototype.revokeSBP = function (_b) {
    ...
    AccountClass.prototype.withdrawSBPReward = function (_b) {
    ...
    AccountClass.prototype.voteForSBP = function (_b) {
        var sbpName = _b.sbpName;
        var err = vitejs_utils_1.checkParams({ sbpName: sbpName }, ['sbpName'], [{
                name: 'sbpName',
                func: vitejs_utils_1.isValidSBPName
    ...
    AccountClass.prototype.cancelSBPVoting = function () {
        return this.callContract({
    ...
    AccountClass.prototype.stakeForQuota = function (_b) {
    ...
    AccountClass.prototype.stakeForQuota_V2 = function (_b) {
        var beneficiaryAddress = _b.beneficiaryAddress, amount = _b.amount;
        var err = vitejs_utils_1.checkParams({ beneficiaryAddress: beneficiaryAddress, amount: amount }, ['beneficiaryAddress', 'amount'], [{
                name: 'beneficiaryAddress',
                func: address_1.isValidAddress
    ...
    AccountClass.prototype.cancelQuotaStake = function (_b) {
        var id = _b.id;
    ...
    AccountClass.prototype.cancelQuotaStake_V2 = function (_b) {
        var beneficiaryAddress = _b.beneficiaryAddress, amount = _b.amount;
        var err = vitejs_utils_1.checkParams({ beneficiaryAddress: beneficiaryAddress, amount: amount }, ['beneficiaryAddress', 'amount'], [{
                name: 'beneficiaryAddress',
                func: address_1.isValidAddress
    ...
    AccountClass.prototype.issueToken = function (_b) {
    ...
    AccountClass.prototype.reIssueToken = function (_b) {
    ...
    AccountClass.prototype.burnToken = function (_b) {
    ...
    AccountClass.prototype.disableReIssueToken = function (_b) {
    ...
    AccountClass.prototype.transferTokenOwnership = function (_b) {
    ...
    AccountClass.prototype.dexDeposit = function (_b) {
        var tokenId = _b.tokenId, amount = _b.amount;
        var err = vitejs_utils_1.checkParams({ tokenId: tokenId, amount: amount }, ['tokenId', 'amount']);
        if (err) {
            throw err;
    ...
    AccountClass.prototype.dexWithdraw = function (_b) {
        var tokenId = _b.tokenId, amount = _b.amount;
        var err = vitejs_utils_1.checkParams({ tokenId: tokenId, amount: amount }, ['tokenId', 'amount']);
        if (err) {
            throw err;
    ...
    AccountClass.prototype.dexOpenNewMarket = function (_b) {
    ...
    AccountClass.prototype.dexPlaceOrder = function (_b) {
    ...
    AccountClass.prototype.dexCancelOrder = function (_b) {
    ...
    AccountClass.prototype.dexStakeForMining = function (_b) {
    ...
    AccountClass.prototype.dexStakeForVIP = function (_b) {
    ...
    AccountClass.prototype.dexMarketAdminConfig = function (_b) {
    ...
    AccountClass.prototype.dexTransferTokenOwnership = function (_b) {
    ...
    AccountClass.prototype.dexCreateNewInviter = function () {
        return this.callContract({
    ...
    AccountClass.prototype.dexBindInviteCode = function (_b) {
        var code = _b.code;
    ...
    AccountClass.prototype.dexStakeForSuperVIP = function (_b) {
        var actionType = _b.actionType;
        var err = vitejs_utils_1.checkParams({ actionType: actionType }, ['actionType'], [{
                name: 'actionType',
    ...
    AccountClass.prototype.dexConfigMarketAgents = function (_b) {
        ...
        var err = vitejs_utils_1.checkParams({ actionType: actionType, agent: agent, tradeTokens: tradeTokens, quoteTokens: quoteTokens }, ['actionType', 'agent', 'tradeTokens', 'quoteTokens'], [{
                ...
                name: 'tradeTokens',
                func: function (_t) {
                    for (var _i = 0, _t_1 = _t; _i < _t_1.length; _i++) {
                        var tti = _t_1[_i];
                        if (!vitejs_utils_1.isValidTokenId(tti)) {
                            return false;
                        }
                    }
                    return true;
                ...
                name: 'quoteTokens',
                func: function (_t) {
                    for (var _i = 0, _t_2 = _t; _i < _t_2.length; _i++) {
                        var tti = _t_2[_i];
                        if (!vitejs_utils_1.isValidTokenId(tti)) {
                            return false;
                        }
    ...
    AccountClass.prototype.dexLockVxForDividend = function (_b) {
        var actionType = _b.actionType, amount = _b.amount;
        var err = vitejs_utils_1.checkParams({ actionType: actionType, amount: amount }, ['actionType', 'amount'], [{
                name: 'actionType',
                func: function (_a) { return Number(actionType) === 1 || Number(actionType) === 2; }
    ...
    AccountClass.prototype.dexSwitchConfig = function (_b) {
    ...
    AccountClass.prototype.dexStakeForPrincipalSVIP = function (_b) {
    ...
    AccountClass.prototype.dexCancelStakeById = function (_b) {
        var id = _b.id;
        var err = vitejs_utils_1.checkParams({ id: id }, ['id'], [{
                name: 'id',
                func: vitejs_utils_1.isHexString
